...
public class ModifyProductController implements Initializable 
{
    ...
    {
        //Makes sure that the product has at least one part
        if(addParts.size() > 0)
        {
            Inventory.deleteProduct(productRef);
    ...
    public void sendModData(Product product)
    {
        productRef = product;
        productIDLabel.setText(String.valueOf(product.getProductID()));
        nameTextField.setText(String.valueOf((product).getProductName()));
        inventoryTextField.setText(String.valueOf((product).getProductStock()));
        priceTextField.setText(String.valueOf((product).getProductPrice()));
        minTextField.setText(String.valueOf((product).getProductMin()));
        maxTextField.setText(String.valueOf((product).getProductMax()));
        
        
        addParts.addAll(product.getAllAssociatedParts());
    }
